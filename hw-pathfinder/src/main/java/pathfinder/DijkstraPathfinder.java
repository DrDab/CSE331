...
/**
 * A pathfinding utility that takes in a DirectedGraph<T, Double> of node type T connected
...
public class DijkstraPathfinder<T>
{
    ...
    /**
     * Instantiates a DijkstraPathFinder for the given graph mapping nodes
